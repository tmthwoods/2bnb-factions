	BNB_FA_Units_Desert(Fin,BNB_FA_Fin_Faction,BNB_FA_Fin_Desert,BNB_FA_Fin_Rifleman_Desert_pack,BNB_FA_Fin_IC_Desert_pack,BNB_FA_Fin_Medic_Desert_pack)
	BNB_FA_Units_Multicam(Fin,BNB_FA_Fin_Faction,BNB_FA_Fin_Multicam,BNB_FA_Fin_Rifleman_Multicam_pack,BNB_FA_Fin_IC_Multicam_pack,BNB_FA_Fin_Medic_Multicam_pack)
	BNB_FA_Units_Winter(Fin,BNB_FA_Fin_Faction,BNB_FA_Fin_Winter,BNB_FA_Fin_Rifleman_Winter_pack,BNB_FA_Fin_IC_Winter_pack,BNB_FA_Fin_Medic_Winter_pack)
	BNB_FA_Units_Woodland(Fin,BNB_FA_Fin_Faction,BNB_FA_Fin_Woodland,BNB_FA_Fin_Rifleman_Woodland_pack,BNB_FA_Fin_IC_Woodland_pack,BNB_FA_Fin_Medic_Woodland_pack)
