	BNB_FA_Units_Desert(Nor,BNB_FA_Nor_Faction,BNB_FA_Nor_Desert,BNB_FA_Nor_Rifleman_Desert_pack,BNB_FA_Nor_IC_Desert_pack,BNB_FA_Nor_Medic_Desert_pack)
	BNB_FA_Units_Multicam(Nor,BNB_FA_Nor_Faction,BNB_FA_Nor_Multicam,BNB_FA_Nor_Rifleman_Multicam_pack,BNB_FA_Nor_IC_Multicam_pack,BNB_FA_Nor_Medic_Multicam_pack)
	BNB_FA_Units_Winter(Nor,BNB_FA_Nor_Faction,BNB_FA_Nor_Winter,BNB_FA_Nor_Rifleman_Winter_pack,BNB_FA_Nor_IC_Winter_pack,BNB_FA_Nor_Medic_Winter_pack)
	BNB_FA_Units_Woodland(Nor,BNB_FA_Nor_Faction,BNB_FA_Nor_Woodland,BNB_FA_Nor_Rifleman_Woodland_pack,BNB_FA_Nor_IC_Woodland_pack,BNB_FA_Nor_Medic_Woodland_pack)
