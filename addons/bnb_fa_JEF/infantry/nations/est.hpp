	BNB_FA_Units_Desert(Est,BNB_FA_Est_Faction,BNB_FA_Est_Desert,BNB_FA_Est_Rifleman_Desert_pack,BNB_FA_Est_IC_Desert_pack,BNB_FA_Est_Medic_Desert_pack)
	BNB_FA_Units_Multicam(Est,BNB_FA_Est_Faction,BNB_FA_Est_Multicam,BNB_FA_Est_Rifleman_Multicam_pack,BNB_FA_Est_IC_Multicam_pack,BNB_FA_Est_Medic_Multicam_pack)
	BNB_FA_Units_Winter(Est,BNB_FA_Est_Faction,BNB_FA_Est_Winter,BNB_FA_Est_Rifleman_Winter_pack,BNB_FA_Est_IC_Winter_pack,BNB_FA_Est_Medic_Winter_pack)
	BNB_FA_Units_Woodland(Est,BNB_FA_Est_Faction,BNB_FA_Est_Woodland,BNB_FA_Est_Rifleman_Woodland_pack,BNB_FA_Est_IC_Woodland_pack,BNB_FA_Est_Medic_Woodland_pack)
