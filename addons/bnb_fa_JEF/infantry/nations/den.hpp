	BNB_FA_Units_Desert(Den,BNB_FA_Den_Faction,BNB_FA_Den_Desert,BNB_FA_Den_Rifleman_Desert_pack,BNB_FA_Den_IC_Desert_pack,BNB_FA_Den_Medic_Desert_pack)
	BNB_FA_Units_Multicam(Den,BNB_FA_Den_Faction,BNB_FA_Den_Multicam,BNB_FA_Den_Rifleman_Multicam_pack,BNB_FA_Den_IC_Multicam_pack,BNB_FA_Den_Medic_Multicam_pack)
	BNB_FA_Units_Winter(Den,BNB_FA_Den_Faction,BNB_FA_Den_Winter,BNB_FA_Den_Rifleman_Winter_pack,BNB_FA_Den_IC_Winter_pack,BNB_FA_Den_Medic_Winter_pack)
	BNB_FA_Units_Woodland(Den,BNB_FA_Den_Faction,BNB_FA_Den_Woodland,BNB_FA_Den_Rifleman_Woodland_pack,BNB_FA_Den_IC_Woodland_pack,BNB_FA_Den_Medic_Woodland_pack)
