BNB_FA_Units_Desert(Lit,BNB_FA_Lit_Faction,BNB_FA_Lit_Desert,BNB_FA_Lit_Rifleman_Desert_pack,BNB_FA_Lit_IC_Desert_pack,BNB_FA_Lit_Medic_Desert_pack)
BNB_FA_Units_Multicam(Lit,BNB_FA_Lit_Faction,BNB_FA_Lit_Multicam,BNB_FA_Lit_Rifleman_Multicam_pack,BNB_FA_Lit_IC_Multicam_pack,BNB_FA_Lit_Medic_Multicam_pack)
BNB_FA_Units_Winter(Lit,BNB_FA_Lit_Faction,BNB_FA_Lit_Winter,BNB_FA_Lit_Rifleman_Winter_pack,BNB_FA_Lit_IC_Winter_pack,BNB_FA_Lit_Medic_Winter_pack)
BNB_FA_Units_Woodland(Lit,BNB_FA_Lit_Faction,BNB_FA_Lit_Woodland,BNB_FA_Lit_Rifleman_Woodland_pack,BNB_FA_Lit_IC_Woodland_pack,BNB_FA_Lit_Medic_Woodland_pack)
