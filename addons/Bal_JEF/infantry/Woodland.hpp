 class BNB_FA_Bal_Rifleman_Woodland: B_Soldier_F
  {
    faction="BNB_FA_Bal_Faction";
    editorSubcategory="BNB_FA_Bal_Woodland";
    side=1;
    displayName="Rifleman Woodland";
    uniformClass="PB_ESTDCU_U";
    ...
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_ESTDCU_H","PB_ESTDCU_Carrier_Rig"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_ESTDCU_H","PB_ESTDCU_Carrier_Rig"};
    backpack="BNB_FA_Bal_Rifleman_Woodland_pack";
  };

  class BNB_FA_Bal_Medic_Woodland: B_medic_F
  {
    faction="BNB_FA_Bal_Faction";
    editorSubcategory="BNB_FA_Bal_Woodland";
    side=1;
    ...
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_ESTDCU_H","PB_ESTDCU_Carrier_Rig"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_ESTDCU_H","PB_ESTDCU_Carrier_Rig"};
    backpack="BNB_FA_Bal_Medic_Woodland_pack";
  };

  class BNB_FA_Bal_IC_Woodland: B_Soldier_SL_F
  {
    faction="BNB_FA_Bal_Faction";
    editorSubcategory="BNB_FA_Bal_Woodland";
    side=1;
    ...
    uniformClass="PB_ESTDCU_U";
    weapons[]={"CUP_arifle_HK416_AGL_Black","rhsusf_weap_glock17g4","Put","Throw"};
    respawnWeapons[]={"CUP_arifle_HK416_AGL_Black","rhsusf_weap_glock17g4","Put","Throw"};
    ...
    respawnMagazines[]={"CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","SmokeShell","SmokeShell","SmokeShell","CUP_17Rnd_9x19_glock17","CUP_17Rnd_9x19_glock17","HandGrenade","HandGrenade","HandGrenade","rhs_mag_M441_HE"};
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","UK3CB_BAF_Soflam_Laserdesignator","PB_ESTDCU_H","PB_ESTDCU_Carrier_Rig"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","UK3CB_BAF_Soflam_Laserdesignator","PB_ESTDCU_H","PB_ESTDCU_Carrier_Rig"};
    backpack="BNB_FA_Bal_IC_Woodland_pack";
  };


  class BNB_FA_Bal_Rifleman_Woodland_pack: PB_BP01_ESTDCU
  {
    scope=2;
  ...
  class BNB_FA_Bal_Medic_Woodland_pack: PB_BP01_ESTDCU
  {
    scope=2;
    class TransportMagazines{};
    class TransportItems
  ...
  class BNB_FA_Bal_IC_Woodland_pack: PB_RT1523BIG_ESTDCU
  {
    scope=2;
    class TransportMagazines
    {
