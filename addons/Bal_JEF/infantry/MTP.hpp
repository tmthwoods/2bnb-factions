  class BNB_FA_Bal_Rifleman_MTP: B_Soldier_F
  {
    faction="BNB_FA_Bal_Faction";
    editorSubcategory = "BNB_FA_Bal_MTP";
    side=1;
    displayName="Rifleman MTP";
    uniformClass="PB_Multicam_ACU_R";
    weapons[]={"CUP_arifle_HK416_Black","rhsusf_weap_glock17g4","UK3CB_BAF_Soflam_Laserdesignator","Put","Throw"};
    respawnWeapons[]={"CUP_arifle_HK416_Black","rhsusf_weap_glock17g4","UK3CB_BAF_Soflam_Laserdesignator","Put","Throw"};
    ...
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_Multicam_FAST_C_E","PB_MAD21_Carrier_Rig"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_Multicam_FAST_C_E","PB_MAD21_Carrier_Rig"};
    backpack="BNB_FA_Bal_Rifleman_MTP_pack";
  };

  class BNB_FA_Bal_Medic_MTP: B_medic_F
  {
    faction="BNB_FA_Bal_Faction";
    editorSubcategory = "BNB_FA_Bal_MTP";
    side=1;
    ...
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_Multicam_FAST_C_E","PB_MAD21_Carrier_Rig"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_Multicam_FAST_C_E","PB_MAD21_Carrier_Rig"};
    backpack="BNB_FA_Bal_Medic_MTP_pack";
  };

  class BNB_FA_Bal_IC_MTP: B_Soldier_SL_F
  {
    faction="BNB_FA_Bal_Faction";
    editorSubcategory = "BNB_FA_Bal_MTP";
    side=1;
    displayName="IC MTP";
    uniformClass="PB_Multicam_ACU_R";
    weapons[]={"CUP_arifle_HK416_AGL_Black","rhsusf_weap_glock17g4","UK3CB_BAF_Soflam_Laserdesignator","Put","Throw"};
    respawnWeapons[]={"CUP_arifle_HK416_AGL_Black","rhsusf_weap_glock17g4","UK3CB_BAF_Soflam_Laserdesignator","Put","Throw"};
    ...
    magazines[]={"CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","SmokeShell","SmokeShell","SmokeShell","CUP_17Rnd_9x19_glock17","CUP_17Rnd_9x19_glock17","HandGrenade","HandGrenade","rhs_mag_M441_HE"};
    respawnMagazines[]={"CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","SmokeShell","SmokeShell","SmokeShell","CUP_17Rnd_9x19_glock17","CUP_17Rnd_9x19_glock17","HandGrenade","HandGrenade","rhs_mag_M441_HE"};
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","UK3CB_BAF_Soflam_Laserdesignator","PB_Multicam_FAST_C_E","PB_MAD21_Carrier_Rig"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","UK3CB_BAF_Soflam_Laserdesignator","PB_Multicam_FAST_C_E","PB_MAD21_Carrier_Rig"};
    backpack="BNB_FA_Bal_IC_MTP_pack";
  };


  class BNB_FA_Bal_Rifleman_MTP_pack: PB_BP01_Multicam
  {
    scope=2;
  ...
  class BNB_FA_Bal_Medic_MTP_pack: PB_BP01_Multicam
  {
    scope=2;
    class TransportMagazines{};
    class TransportItems
  ...
  class BNB_FA_Bal_IC_MTP_pack: PB_RT1523BIG_Multicam
  {
    scope=2;
    class TransportMagazines
    {
