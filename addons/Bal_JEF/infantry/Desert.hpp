  ...
  class BNB_FA_Bal_Rifleman_Desert: B_Soldier_F
  {
    faction="BNB_FA_Bal_Faction";
    editorSubcategory = "BNB_FA_Bal_Desert";
    side=1;
    displayName="Rifleman Desert";
    uniformClass="PB_TROP_Gora_RU";
    ...
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_TROP_M92","PB_TROP_Carrier_Rig"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_TROP_M92","PB_TROP_Carrier_Rig"};
    backpack="BNB_FA_Bal_Rifleman_Desert_pack";
  };

  class BNB_FA_Bal_Medic_Desert: B_medic_F
  {
    faction="BNB_FA_Bal_Faction";
    editorSubcategory = "BNB_FA_Bal_Desert";
    side=1;
    ...
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_TROP_M92","PB_TROP_Carrier_Rig"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","PB_TROP_M92","PB_TROP_Carrier_Rig"};
    backpack="BNB_FA_Bal_Medic_Desert_pack";
  };

  class BNB_FA_Bal_IC_Desert: B_Soldier_SL_F
  {
    faction="BNB_FA_Bal_Faction";
    editorSubcategory = "BNB_FA_Bal_Desert";
    side=1;
    ...
    respawnMagazines[]={"CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","CUP_30Rnd_556x45_Stanag","SmokeShell","SmokeShell","SmokeShell","CUP_17Rnd_9x19_glock17","CUP_17Rnd_9x19_glock17","HandGrenade","HandGrenade","HandGrenade","rhs_mag_M441_HE"};
    linkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","UK3CB_BAF_Soflam_Laserdesignator","PB_TROP_M92","PB_TROP_Carrier_Rig"};
    respawnLinkedItems[]={"ItemMap","ItemCompass","ItemWatch","TFAR_anprc152","ItemGPS","UK3CB_BAF_Soflam_Laserdesignator","PB_TROP_M92","PB_TROP_Carrier_Rig"};
    backpack="BNB_FA_Bal_IC_Desert_pack";
  };


  class BNB_FA_Bal_Rifleman_Desert_pack: PB_BP01_Tropentarn
  {
    scope=2;
  ...
  class BNB_FA_Bal_Medic_Desert_pack: PB_BP01_Tropentarn
  {
    scope=2;
    class TransportMagazines{};
    class TransportItems
  ...
  class BNB_FA_Bal_IC_Desert_pack: PB_RT1523BIG_TROP
  {
    scope=2;
    class TransportMagazines
    {
